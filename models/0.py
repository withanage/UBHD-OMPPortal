...
settings.keywords = 'heiUP, Heidelberg University Publishing, Universität Heidelberg, digital, Open Access, Peer Review, visibility, academic publishing'
settings.description = 'heiUP ist ein Open-Access-Verlag für wissenschaftliche Publikationen. Alle Titel durchlaufen ein Peer Review und erscheinen als Print und digital'
